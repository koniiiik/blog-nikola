...
BLOG_AUTHOR = "Michal 'koniiiik' Petrucha"  # (translatable)
BLOG_TITLE = "The blog of koniiiik"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://people.ksp.sk/~johnny64/blog/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://nikola.ralsina.com.ar"
BLOG_EMAIL = "koniiiik@ksp.sk"
BLOG_DESCRIPTION = "Tales of a Python coder / system administrator"  # (translatable)
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=xa-51e2a6611bdadc14"></script>
...
<script>
  ...
  ga('create', 'UA-41679017-1', 'ksp.sk');
  ga('send', 'pageview');
